...
import org.openapitools.client.model.ApprovalInfo;
...
public class TreeResourceVersion {
  ...
  public static final String SERIALIZED_NAME_APPROVAL_INFO = "approvalInfo";
  @SerializedName(SERIALIZED_NAME_APPROVAL_INFO)
  ...
  **/
  ...
  public TreeResourceVersion categories(Set<ResourceCategory> categories) {
  ...
  **/
  ...
  public TreeResourceVersion domains(Set<Domain> domains) {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("approvalInfo");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `approvalInfo`
      if (jsonObj.get("approvalInfo") != null && !jsonObj.get("approvalInfo").isJsonNull()) {
        ApprovalInfo.validateJsonElement(jsonObj.get("approvalInfo"));
      }
