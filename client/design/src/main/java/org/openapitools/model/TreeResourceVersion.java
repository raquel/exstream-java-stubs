...
public class TreeResourceVersion {
  ...
  */
  ...
  public TreeResourceVersion approvalInfo(ApprovalInfo approvalInfo) {
  ...
  */
  ...
  public TreeResourceVersion categories(Set<@Valid ResourceCategory> categories) {
  ...
  */
  ...
  public TreeResourceVersion domains(Set<@Valid Domain> domains) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowNestedSections, treeResourceVersion.allowNestedSections) &&
        Objects.equals(this.approvalInfo, treeResourceVersion.approvalInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowNestedSections, approvalInfo, categories, containsActiveRevisions, content, contentMimeType, contentType, createdBy, createdDate, description, domains, effectiveEnd, effectiveStart, hidden, id, isTrackingRevisions, lastModifiedBy, lastModifiedDate, latestVersion, locked, lockedBy, metadata, name, permissions, resourcePackId, standardVariantId, state, stateComment, subtype, systemResource, type, variants, version);
  }
